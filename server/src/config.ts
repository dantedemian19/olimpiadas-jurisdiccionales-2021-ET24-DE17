...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'prueba';
    ...
    'jhipster.mail.from' = 'prueba@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'prueba API';
    'jhipster.swagger.description' = 'prueba API documentation';
    ...
    'eureka.instance.appname' = 'prueba';
    'eureka.instance.instanceId' = 'prueba:${random.value}';
