...
export class CiudadDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('pruebaApp.ciudad.delete.question'));
...
export default class CiudadComponentsPage {
  ...
  async deleteCiudad() {
    ...
    expect(await ciudadDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/pruebaApp.ciudad.delete.question/);
