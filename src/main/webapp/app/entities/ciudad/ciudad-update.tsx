  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pruebaApp.ciudad.home.createOrEditLabel" data-cy="CiudadCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : ciudadEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="provinciaIdLabel" for="ciudad-provinciaId">
                  Provincia Id
                </Label>
                <AvField id="ciudad-provinciaId" data-cy="provinciaId" type="text" name="provinciaId" />
              </AvGroup>
